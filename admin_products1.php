   ...
   if(mysqli_num_rows($select_product_name) > 0){
      $message[] = 'product name already added';
         ...
         if($image_size > 200000){
            ...
            $add_product_query = mysqli_query($conn, "INSERT INTO products (name, author, description, categories, price, image1) VALUES('$name', '$author', '$desc',  '$cat', '$price', '$image1')") or die('query failed'.$conn->error);
