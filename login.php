...
<style>
   ...
   .form-containers {
	background: linear-gradient(-45deg, #974027, #93234f, #186f8f, #116350);
...
<div class="login-box">
  ...
  <form action='' method='post' autocomplete="off">
    ...
    <p class='dont'> Don't have an account? </p>  <a class='reg' href="register.php"> register now
</div>
